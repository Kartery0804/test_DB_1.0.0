...
@regulate(0)
def get_regulate_code(conn:pymysql.Connection,username:str,defalut_code:int = 0):
    try:
        ...
        return int(role_code["data"][0][om.find_index(role_code["column_name"],"role_code")],2)
